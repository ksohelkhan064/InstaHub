...
const [isBookmarked, setIsBookmarked] = useState(user.bookmarks.includes(postId)); // Local state to manage bookmark status
    ...
    return (
        ...
        // </span>
            ...
            isBookmarked ? (
              <FaBookmark onClick={unbookmarkHandler} size={'24'} className='cursor-pointer text-gray-600' />
            ) : (
